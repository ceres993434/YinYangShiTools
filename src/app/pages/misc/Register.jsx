			...
			<div id="extr-page">
				<header id="header" className="animated fadeInDown">
					...
					<span id="extr-page-header-space">
						<span className="hidden-mobile hiddex-xs">Already registered?</span>&nbsp;<a href="#login" className="btn btn-danger">Sign In</a>
					</span>
					...
					<div id="content" className="container">
						...
						<div className="row">
							<div className="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
								<h1 className="txt-color-red login-header-big">233</h1>
								<div className="hero">
									...
									<img src="styles/img/demo/iphoneview.png" alt="" className="pull-right display-image" style={{
										width: '210px'
									}}/>
